...
class TripRequirement
{
     ...
     * @return TripRequirement
     */
    public function setDepartureStationName(?string $DepartureStationName): TripRequirement
    {
     ...
     * @return TripRequirement
     */
    public function setArrivalStationName(?string $ArrivalStationName): TripRequirement
    {
