...
class Ticket
{
    ...
    /**
     * @var null|float $IsMilitaryPreference
     */
    ...
    /**
     * @var null|Collection|Passenger[] $Passengers
     */
    ...
    /**
     * @var null|string $TransportRequirementsInfo
     */
     ...
     * @return float|null
     */
    public function getIsMilitaryPreference(): ?float
    {
        return $this->IsMilitaryPreference;
    }

    /**
     * @param float|null $IsMilitaryPreference
     * @return Ticket
     */
    public function setIsMilitaryPreference(?float $IsMilitaryPreference): Ticket
    {
     ...
     * @return null
     */
    public function getPreferenceTariffInfo()
    {
        return $this->PreferenceTariffInfo;
    }

    /**
     * @param null $PreferenceTariffInfo
     * @return Ticket
     */
    public function setPreferenceTariffInfo($PreferenceTariffInfo)
    {
     ...
     * @return string|null
     */
    public function getTransportRequirementsInfo(): ?string
    {
        return $this->TransportRequirementsInfo;
    }

    /**
     * @param string|null $TransportRequirementsInfo
     * @return Ticket
     */
    public function setTransportRequirementsInfo(?string $TransportRequirementsInfo): Ticket
    {
     ...
     * @return Ticket
     */
    public function setReissueDetail(?string $ReissueDetail): Ticket
    {
