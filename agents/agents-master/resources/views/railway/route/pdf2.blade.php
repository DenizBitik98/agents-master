...
<p>
@if($forwardDirection) Туда: {{$departureStation}} - {{$arrivalStation}}, {{$departureDate}} <br>  @endif
@if($backwardDirection) Обратно: {{$arrivalStation}} - {{$departureStation}}, {{$departureDate}} <br>  @endif
