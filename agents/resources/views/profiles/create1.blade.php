                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <select class="form-select" name="tariff_type" id="tariff_type">
                                    <option value="0" {{ old('tariff_type') == "0" ? "selected" : "" }}>Взрослый
                                    </option>
                                    <option value="1" {{ old('tariff_type') == "1" ? "selected" : "" }}>Детский</option>
                                </select>
                                @error('tariff_type')
                                ...
                                <select class="form-select document-type" name="document_type_id" id="document_type_id">
                                    @foreach($docTypes as $docType)
                                        <option value="{{$docType->id}}"
                                            ...
                                            {{ old('document_type_id') == $docType->id ? "selected" : ""}}>{{$docType->name}}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="document" id="document" value="{{ old('document') }}">
                                @error('document')
                                <div class="invalid-feedback show-error">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="passenger_iin" id="passenger_iin" value="{{ old('passenger_iin') }}">
                                @error('passenger_iin')
                                <div class="invalid-feedback show-error">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="birthday" id="birthday" type="date" value="{{ old('birthday') }}">
                                @error('birthday')
                                <div class="invalid-feedback show-error">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" name="sex" id="sex">
                                    @foreach($sexList as $k=>$sex)
                                        <option value="{{$k}}" {{ old('sex') == $k ? "selected" : "" }}>{{$sex}}</option>
                                    @endforeach
                                </select>
                                @error('sex')
                                <div class="invalid-feedback show-error">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control phone-number" name="phone" id="phone" value="{{ old('phone') }}">
                                @error('phone')
                                <div class="invalid-feedback show-error">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" name="citizenship_id" id="citizenship_id">
                                    @foreach($countries as $country)
                                        <option value="{{$country->id}}" {{ old('citizenship_id') == $country->id ? "selected" : "" }}>{{$country->name}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="external_id" id="external_id" value="{{ old('external_id') }}">
                                @error('external_id')
                                <div class="invalid-feedback show-error">
                                    {{ $message }}
                                </div>
